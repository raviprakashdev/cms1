...
?>
<form action="posttest.php?id=<?php echo $id;?>" method="POST">
...
<a href="posttest.php?id=<?php echo $row['id'];?>" class="white-text">Read More</a>
</div>
</div>
</div>
<?php
...
if($res3)
{
  ...
  header("Location: posttest.php?id=$id1");
